...
from activephasemap.models.dkl import MultiTaskDKLGP
...
def run_iteration(expt):
    ...
    gp_model = MultiTaskDKLGP(normalized_x, train_y, gp_model_args, DESIGN_SPACE_DIM, N_LATENT, train_y_std)
