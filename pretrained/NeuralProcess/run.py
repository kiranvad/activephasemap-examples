...
from datasets import GaussianProcess, UVVis
import numpy as np 
import os, shutil 
...
LEARNING_RATE = 1e-4
BATCH_SIZE = 16
UVVIS_DATA_DIR = "../uvvis_data_npy/"

dataset_train = UVVis(root_dir=UVVIS_DATA_DIR, batch_size=16, max_num_context=MAX_CONTEXT_POINTS)
dataset_test = UVVis(root_dir=UVVIS_DATA_DIR, batch_size=1, max_num_context=MAX_CONTEXT_POINTS, testing=True)
